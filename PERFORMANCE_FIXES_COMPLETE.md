...
Copy-paste from [docs/PERFORMANCE.md](docs/PERFORMANCE.md):
...
**Performance Guide:**
- [docs/PERFORMANCE.md](docs/PERFORMANCE.md) - Complete optimization guide with presets
...
**Questions?**
- Check [docs/PERFORMANCE.md](docs/PERFORMANCE.md) for troubleshooting
...
**Ready to use**: Copy a preset from [docs/PERFORMANCE.md](docs/PERFORMANCE.md) and start querying!
